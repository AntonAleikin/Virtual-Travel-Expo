...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/smooth-scroll */ "./src/js/modules/smooth-scroll.js");
...
/* harmony import */ var _modules_nav_mobile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/nav-mobile */ "./src/js/modules/nav-mobile.js");
...
/* harmony import */ var _modules_video_player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/video-player */ "./src/js/modules/video-player.js");
/* harmony import */ var _modules_galery_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/galery-slider */ "./src/js/modules/galery-slider.js");
/* harmony import */ var _modules_send_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/send-form */ "./src/js/modules/send-form.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_3__["default"])('.accordeon__item', 4200, '', '');
  Object(_modules_video_player__WEBPACK_IMPORTED_MODULE_4__["default"])(); //galerySlider();

  Object(_modules_send_form__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./src/js/modules/contact-overlay.js":
/*!*******************************************!*\
  !*** ./src/js/modules/contact-overlay.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_fetch_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/fetch-service */ "./src/js/services/fetch-service.js");
/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./overlay */ "./src/js/modules/overlay.js");
...
var contactOverlay = function contactOverlay() {
  ...
  function close() {
    var contactOverlayClose = document.querySelector('.contact-overlay__close');
    contactOverlayClose.addEventListener("click", function () {
  ...
  function sendForm() {
    ...
    formOverlay.addEventListener("submit", function (e) {
      e.preventDefault();
      ...
      Object(_services_fetch_service__WEBPACK_IMPORTED_MODULE_2__["default"])('php/send-mail.php', formDataObject).then(function (response) {
        if (response === true) {
          modal.remove();
          setTimeout(function () {
            formOverlay.reset();
          }, 2000);
          Object(_overlay__WEBPACK_IMPORTED_MODULE_3__["default"])();
        }
      });
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (contactOverlay);

/***/ }),

/***/ "./src/js/modules/galery-slider.js":
/*!*****************************************!*\
  !*** ./src/js/modules/galery-slider.js ***!
  \*****************************************/
/*! exports provided: default */
...
var galerySlider = function galerySlider() {
  var galerySection = document.querySelector('.galery-section'),
  ...
  function removeBtn() {
    if (window.matchMedia('(min-width: 768px)').matches) {
      ...
      setTimeout(function () {
        var overlay = document.querySelector('.fslightbox-absoluted'),
  ...
  swiperSlideImg.forEach(function (img) {
  ...
  function defImgLoad() {
    if (swiperSlideImg[0].getBoundingClientRect().top < window.innerHeight + window.scrollY && swiperSlideImg[0].classList.contains('lazy-load') && !galerySection.classList.contains('galery-section-bg')) {
  ...
  if (window.matchMedia("(max-width: 767px)").matches) {
    var galeryLink = document.querySelector('[href="#stands"]');
...
/* harmony default export */ __webpack_exports__["default"] = (galerySlider());
...
/* harmony default export */ __webpack_exports__["default"] = (headerShadow);

/***/ }),

/***/ "./src/js/modules/nav-mobile.js":
/*!**************************************!*\
  !*** ./src/js/modules/nav-mobile.js ***!
  \**************************************/
/*! exports provided: default */
...
function navMobile() {
  if (window.matchMedia('(max-width: 767px)').matches) {
    ...
    hamburger.addEventListener("click", function () {
      if (!hamburger.classList.contains('nav__hamburger_active') && !navLinks.classList.contains('nav__links_active')) {
    ...
    var links = navLinks.querySelectorAll('.nav__links-item');
...
function overlay() {
  ...
  document.documentElement.style.overflow = 'hidden';
  body.append(modal);
  var closeButton = document.querySelector('.overlay-button');
...
var sliders = function sliders(slides, speed, prev, next) {
  var items = document.querySelectorAll(slides); // Слайды из аргумента

  var slideIndex = 1; // Слайд, который показываем пользувателю
  ...
  showSlides(slideIndex); // Ф-ция прокрутки слайдов. Вызываем кнопками или автоматически
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _contact_overlay__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contact-overlay */ "./src/js/modules/contact-overlay.js");
...
var smoothScroll = function smoothScroll() {
  function scroll(hash, speed) {
    try {
      ...
      var step = function step(time) {
        ...
        r = toBlock < 0 ? Math.max(windowTop - progress / speed, windowTop + toBlock) : Math.min(windowTop + progress / speed, windowTop + toBlock);
        window.scrollTo(0, r);
      ...
      if (link.dataset.modal == 'form') {
        link.addEventListener("click", function (e) {
          ...
          if (window.scrollY >= 2760) {
            ...
            Object(_contact_overlay__WEBPACK_IMPORTED_MODULE_2__["default"])();
          }
        });
      } else {
        link.addEventListener("click", function (e) {
  ...
  if (window.matchMedia("(max-width: 767px)").matches) {
    var sectionLink = document.querySelector('.section-link__link'),
...
var videoPlayer = function videoPlayer() {
  ...
  function defPlayerLoad() {
    ...
    if (videoPlayer.getBoundingClientRect().top < window.innerHeight + window.scrollY && videoPlayer.classList.contains('lazy-load')) {
...
/***/ "./src/js/services/fetch-service.js":
/*!******************************************!*\
  !*** ./src/js/services/fetch-service.js ***!
  \******************************************/
/*! exports provided: default */
...
function _fetchservice() {
  _fetchservice = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(header, myBody) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", fetch(header).then(function (respose) {
              return respose.json();
            }));

          case 4:
            return _context.abrupt("return", fetch(header, {
              method: "POST",
              headers: {
