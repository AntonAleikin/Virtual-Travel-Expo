...
var galerySlider = function galerySlider() {
  ...
  function defImgLoad() {
    if ((window.scrollY >= galerySection.getBoundingClientRect().top - 150 || galerySection.getBoundingClientRect().top == 0) && swiperSlideImg[0].src != location.origin + '/' + swiperSlideImg[0].dataset.src) {
